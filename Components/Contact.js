...
function Contact() {
  return <div id="Contact" className='m-auto  justify-center items-center'>
		...
		<div className='flex  justify-center items-center'>
			<a href="https://www.linkedin.com/in/fatima-seemab-84a8b61b3/">
				<div className=' hover:shadow-lg rounded-md hover:scale-105  transition delay-150 bg-gray-300 h-18 w-18 m-5'>
