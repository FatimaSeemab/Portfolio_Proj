...
function Skills() {
  return <div className='m-5'>
	  ...
	  <div className='grid my-10 border-2 border-gray-900  grid-cols-1 md:grid-cols-4 sm:grid-cols-2 lg:grid-cols-6'>
		  <div className='m-5 h-36 shadow-xl hover:shadow-2xl hover:shadow-gray-500  hover:scale-105 bg-gray-300 text-white'>
			  
			  <img className="h-24  w-full" src={"../images/React.png"} alt=""/>
			  <p className='mt-2 text-center text-2xl font-semibold'>React </p>
		  </div>
		  <div className='m-5 h-36 shadow-xl hover:shadow-2xl hover:shadow-gray-500  hover:scale-105 bg-gray-300 text-black'>
